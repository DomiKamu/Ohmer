//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// THIS MODULE IS DEPRECATED AND DON'T BE USED ANYMORE!
// PLEASE REPLACE ALL INSTANCES IN YOUR PATCHES BY "KLOKSPID MKII", INSTEAD! THANK YOU FOR YOUR UNDERSTANDINGS
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
struct KlokSpidModule : Module {
	...
	int Theme; // 0 = Creamy, 1 = Stage Repro, 2 = Absolute Night, 3 = Dark Signature, 4 = Deepblue Signature, 5 = Titanium Signature.
...
struct KlokSpidWidget : ModuleWidget {
	...
	void step() override {
		...
		// Possible panels.
		panelKlokSpidCreamy->visible = (module->Theme == 0);
		...
		panelKlokSpidTitaniumSignature->visible = (module->Theme == 5);
